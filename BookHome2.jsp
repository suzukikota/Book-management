...
<dic class="searchform">
	...
	<%} %>
			...
			<%if(total>=11 && total<21){%>
				...
				<div class="cp_pagination">
					<span aria-current="page" class="cp_pagenum current">1</span>
					<a class="cp_pagenum" href="BookHome2.jsp?param=2">2</a>
				</div>
				</nav>
			<%} %>
			...
			<%if(total>=21 && total<31){%>
				...
				<div class="cp_pagination">
					<span aria-current="page" class="cp_pagenum current">1</span>
					<a class="cp_pagenum" href="BookHome2.jsp?param=2">2</a>
					<a class="cp_pagenum" href="BookHome2.jsp?param=3">3</a>
				</div>
				</nav>
			<%} %>
			...
			<%if(total>=31 && total<41){%>
				...
				<div class="cp_pagination">
					...
					<a class="cp_pagenum" href="BookHome2.jsp?param=2">2</a>
					<a class="cp_pagenum" href="BookHome2.jsp?param=3">3</a>
					<a class="cp_pagenum" href="BookHome2.jsp?param=4">4</a>
				</div>
				</nav>
			<%} %>

	<!-- BookHome.jspからの検索によるTOPからページング選択後 -->
	<%}else if(param!=null){%>
	...
	<%} %>
			...
			<%if(num==2){%>
				<%if(total>=11 && total<21){%>
					<nav class="cp_navi">
						<div class="cp_pagination">
							<a class="cp_pagenum" href="BookHome2.jsp?param=1">1</a>
							<span aria-current="page" class="cp_pagenum current">2</span>
						</div>
					</nav>
				<%}%>
